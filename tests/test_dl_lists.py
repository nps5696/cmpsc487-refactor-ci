...
def test_adding_and_removing_nodes():
    ...
    assert dll.get_first().get_element() == 1
    assert dll.get_last().get_element() == 1

    dll.add_last(node2)
    assert dll.size() == 2
    assert dll.get_first().get_element() == 1
    assert dll.get_last().get_element() == 2
...
# #
#
# iterator = iter(dL)  # Get an iterator from dL
#
# try:
#     while True:
#         node = next(iterator)
#         print(node.get_element() == node.get_element())
#         print(dL)
